...
public final class AimAnalysisCheck implements PacketCheckHandler {
    ...
    public AimAnalysisCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("aim_analysis", d); }
}