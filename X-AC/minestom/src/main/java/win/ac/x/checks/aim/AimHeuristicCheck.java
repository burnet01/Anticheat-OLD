...
public final class AimHeuristicCheck implements PacketCheckHandler {
    ...
    public AimHeuristicCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("aim_heuristic", d); }
}