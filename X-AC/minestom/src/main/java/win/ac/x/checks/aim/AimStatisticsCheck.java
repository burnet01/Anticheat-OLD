...
public final class AimStatisticsCheck implements PacketCheckHandler {
    ...
    public AimStatisticsCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("aim_statistics", d); }
}