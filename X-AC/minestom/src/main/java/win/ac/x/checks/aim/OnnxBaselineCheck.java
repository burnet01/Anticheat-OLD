...
public final class OnnxBaselineCheck implements PacketCheckHandler {
    ...
    public OnnxBaselineCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("onnx_baseline", d); }
}