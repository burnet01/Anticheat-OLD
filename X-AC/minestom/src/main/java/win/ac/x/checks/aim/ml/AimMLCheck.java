...
public final class AimMLCheck implements PacketCheckHandler {
    ...
    public AimMLCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("aim_ml", d); }
}