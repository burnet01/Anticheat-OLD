...
public final class AutoClickerCheck implements PacketCheckHandler {
    ...
    public AutoClickerCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("autoclicker", d); }
}