...
public final class BaritoneCheck implements PacketCheckHandler {
    ...
    public BaritoneCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("baritone", d); }
}