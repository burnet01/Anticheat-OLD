...
public final class GhostBlockAbuseCheck implements PacketCheckHandler {
    ...
    public GhostBlockAbuseCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ghost_block_abuse", d); }
}