...
public final class OnnxPhysicsCheck implements PacketCheckHandler {
    ...
    public OnnxPhysicsCheck(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("onnx_physics", d); }
}