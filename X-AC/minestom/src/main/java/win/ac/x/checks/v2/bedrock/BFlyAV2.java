...
public final class BFlyAV2 implements PacketCheckHandler {
    ...
    public BFlyAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bfly_v2", d); }
}