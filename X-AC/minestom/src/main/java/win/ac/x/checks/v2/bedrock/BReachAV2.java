...
public final class BReachAV2 implements PacketCheckHandler {
    ...
    public BReachAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("breach_v2", d); }
}