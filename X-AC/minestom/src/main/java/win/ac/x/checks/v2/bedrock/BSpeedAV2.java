...
public final class BSpeedAV2 implements PacketCheckHandler {
    ...
    public BSpeedAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bspeed_v2", d); }
}