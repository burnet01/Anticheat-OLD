package win.ac.x.checks.v2.combat.anchor;
...
public final class AnchorAuraAV2 implements PacketCheckHandler {
    ...
    public AnchorAuraAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("anchor_aura_v2", d); }
}