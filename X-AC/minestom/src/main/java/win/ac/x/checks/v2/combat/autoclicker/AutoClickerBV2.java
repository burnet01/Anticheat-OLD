...
public final class AutoClickerBV2 implements PacketCheckHandler {
    ...
    public AutoClickerBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("autoclicker_b_v2", d); }
}