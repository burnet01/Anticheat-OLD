...
public final class AutoClickerCV2 implements PacketCheckHandler {
    ...
    public AutoClickerCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("autoclicker_c_v2", d); }
}