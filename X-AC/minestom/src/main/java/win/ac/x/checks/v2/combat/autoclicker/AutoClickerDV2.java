...
public final class AutoClickerDV2 implements PacketCheckHandler {
    ...
    public AutoClickerDV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("autoclicker_d_v2", d); }
}