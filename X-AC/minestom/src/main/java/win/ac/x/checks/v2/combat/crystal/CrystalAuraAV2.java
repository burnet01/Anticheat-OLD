...
public final class CrystalAuraAV2 implements PacketCheckHandler {
    ...
    public CrystalAuraAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("crystal_aura_v2", d); }
}