package win.ac.x.checks.v2.combat.hitbox;
...
public final class HitboxAV2 implements PacketCheckHandler {
    ...
    public HitboxAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("hitbox_v2", d); }
}