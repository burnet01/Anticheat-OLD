...
public final class KillAuraBV2 implements PacketCheckHandler {
    ...
    public KillAuraBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_b_v2", d); }
}