...
public final class KillAuraCV2 implements PacketCheckHandler {
    ...
    public KillAuraCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_c_v2", d); }
}