...
public final class KillAuraDV2 implements PacketCheckHandler {
    ...
    public KillAuraDV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_d_v2", d); }
}