...
public final class KillAuraEV2 implements PacketCheckHandler {
    ...
    public KillAuraEV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_e_v2", d); }
}