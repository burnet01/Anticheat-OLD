...
public final class KillAuraFV2 implements PacketCheckHandler {
    ...
    public KillAuraFV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_f_v2", d); }
}