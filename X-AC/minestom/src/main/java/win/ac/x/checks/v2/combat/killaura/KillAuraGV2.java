...
public final class KillAuraGV2 implements PacketCheckHandler {
    ...
    public KillAuraGV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_g_v2", d); }
}