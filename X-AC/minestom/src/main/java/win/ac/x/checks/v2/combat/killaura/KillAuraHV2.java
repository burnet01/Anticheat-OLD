...
public final class KillAuraHV2 implements PacketCheckHandler {
    ...
    public KillAuraHV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("killaura_h_v2", d); }
}