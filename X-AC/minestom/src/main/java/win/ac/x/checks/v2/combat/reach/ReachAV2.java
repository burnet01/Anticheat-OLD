...
public final class ReachAV2 implements PacketCheckHandler {
    ...
    public ReachAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("reach_v2", d); }
}