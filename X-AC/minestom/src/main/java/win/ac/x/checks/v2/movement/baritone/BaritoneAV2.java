...
public final class BaritoneAV2 implements PacketCheckHandler {
    ...
    public BaritoneAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("baritone_a_v2", d); }
}