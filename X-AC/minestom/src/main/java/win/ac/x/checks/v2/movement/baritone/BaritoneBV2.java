...
public final class BaritoneBV2 implements PacketCheckHandler {
    ...
    public BaritoneBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("baritone_b_v2", d); }
}