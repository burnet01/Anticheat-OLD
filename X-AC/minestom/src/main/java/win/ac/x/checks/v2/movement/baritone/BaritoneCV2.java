...
public final class BaritoneCV2 implements PacketCheckHandler {
    ...
    public BaritoneCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("baritone_c_v2", d); }
}