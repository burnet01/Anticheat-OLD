...
public final class InventoryAV2 implements PacketCheckHandler {
    ...
    public InventoryAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("inventory_v2", d); }
}