package win.ac.x.checks.v2.movement.simulation;
...
public final class SimulationBV2 implements PacketCheckHandler {
    ...
    public SimulationBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("simulation_b_v2", d); }
}