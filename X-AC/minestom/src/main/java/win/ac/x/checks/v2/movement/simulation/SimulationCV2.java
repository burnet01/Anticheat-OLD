...
public final class SimulationCV2 implements PacketCheckHandler {
    ...
    public SimulationCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("simulation_c_v2", d); }
}