...
public final class SimulationDV2 implements PacketCheckHandler {
    ...
    public SimulationDV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("simulation_d_v2", d); }
}