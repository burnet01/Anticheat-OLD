...
public final class GroundSpoofBV2 implements PacketCheckHandler {
    ...
    public GroundSpoofBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_b_v2", d); }
}