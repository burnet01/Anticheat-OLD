...
public final class GroundSpoofCV2 implements PacketCheckHandler {
    ...
    public GroundSpoofCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_c_v2", d); }
}