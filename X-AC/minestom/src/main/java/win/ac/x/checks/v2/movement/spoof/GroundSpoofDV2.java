...
public final class GroundSpoofDV2 implements PacketCheckHandler {
    ...
    public GroundSpoofDV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_d_v2", d); }
}