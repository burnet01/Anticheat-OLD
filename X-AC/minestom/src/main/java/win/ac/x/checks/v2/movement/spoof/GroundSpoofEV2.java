...
public final class GroundSpoofEV2 implements PacketCheckHandler {
    ...
    public GroundSpoofEV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_e_v2", d); }
}