...
public final class GroundSpoofFV2 implements PacketCheckHandler {
    ...
    public GroundSpoofFV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_f_v2", d); }
}