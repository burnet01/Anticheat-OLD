...
public final class GroundSpoofGV2 implements PacketCheckHandler {
    ...
    public GroundSpoofGV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("ground_spoof_g_v2", d); }
}