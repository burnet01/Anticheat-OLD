...
public final class BadPacketAV2 implements PacketCheckHandler {
    ...
    public BadPacketAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_a_v2", d); }
}