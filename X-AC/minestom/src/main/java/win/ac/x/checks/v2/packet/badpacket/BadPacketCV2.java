...
public final class BadPacketCV2 implements PacketCheckHandler {
    ...
    public BadPacketCV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_c_v2", d); }
}