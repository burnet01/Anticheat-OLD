...
public final class BadPacketEV2 implements PacketCheckHandler {
    ...
    public BadPacketEV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_e_v2", d); }
}