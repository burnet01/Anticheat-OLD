...
public final class BadPacketGV2 implements PacketCheckHandler {
    ...
    public BadPacketGV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_g_v2", d); }
}