...
public final class BadPacketHV2 implements PacketCheckHandler {
    ...
    public BadPacketHV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_h_v2", d); }
}