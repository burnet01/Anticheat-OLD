...
public final class BadPacketJV2 implements PacketCheckHandler {
    ...
    public BadPacketJV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_j_v2", d); }
}