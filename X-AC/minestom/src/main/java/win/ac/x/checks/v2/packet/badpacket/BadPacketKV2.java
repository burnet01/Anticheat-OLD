...
public final class BadPacketKV2 implements PacketCheckHandler {
    ...
    public BadPacketKV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("bad_packet_k_v2", d); }
}