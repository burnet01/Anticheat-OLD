package win.ac.x.checks.v2.packet.crasher;
...
public final class CrasherAV2 implements PacketCheckHandler {
    ...
    public CrasherAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("crasher_a_v2", d); }
}