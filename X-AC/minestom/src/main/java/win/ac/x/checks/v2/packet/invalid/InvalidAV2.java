package win.ac.x.checks.v2.packet.invalid;
...
public final class InvalidAV2 implements PacketCheckHandler {
    ...
    public InvalidAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("invalid_v2", d); }
}