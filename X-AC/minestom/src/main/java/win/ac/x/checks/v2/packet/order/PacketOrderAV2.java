...
public final class PacketOrderAV2 implements PacketCheckHandler {
    ...
    public PacketOrderAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("packet_order_a_v2", d); }
}