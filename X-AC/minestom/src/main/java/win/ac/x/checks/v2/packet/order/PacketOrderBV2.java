package win.ac.x.checks.v2.packet.order;
...
public final class PacketOrderBV2 implements PacketCheckHandler {
    ...
    public PacketOrderBV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("packet_order_b_v2", d); }
}