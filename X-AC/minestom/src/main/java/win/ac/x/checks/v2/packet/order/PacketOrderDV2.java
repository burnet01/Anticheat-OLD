...
public final class PacketOrderDV2 implements PacketCheckHandler {
    ...
    public PacketOrderDV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("packet_order_d_v2", d); }
}