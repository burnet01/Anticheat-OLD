...
public final class TimerAV2 implements PacketCheckHandler {
    ...
    public TimerAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("timer_v2", d); }
}