package win.ac.x.checks.v2.raycast;
...
public final class RaycastAV2 implements PacketCheckHandler {
    ...
    public RaycastAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("raycast_v2", d); }
}