package win.ac.x.checks.v2.world.fastbreak;
...
public final class FastBreakAV2 implements PacketCheckHandler {
    ...
    public FastBreakAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("fast_break_v2", d); }
}