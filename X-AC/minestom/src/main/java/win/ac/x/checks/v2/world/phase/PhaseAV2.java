package win.ac.x.checks.v2.world.phase;
...
public final class PhaseAV2 implements PacketCheckHandler {
    ...
    public PhaseAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("phase_v2", d); }
}