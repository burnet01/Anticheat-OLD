package win.ac.x.checks.v2.world.scaffold;
...
public final class ScaffoldAV2 implements PacketCheckHandler {
    ...
    public ScaffoldAV2(PlayerProfile profile) { this.profile = profile; }
    ...
    @Override public ConfigLabel config() { Map<String, Object> d = new HashMap<>(); d.put("enabled", true); return new ConfigLabel("scaffold_v2", d); }
}